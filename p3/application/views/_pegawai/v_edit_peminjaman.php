...
<div class="box box-warning">
            ...
            <!-- form start -->
            <?php echo form_open('c_pegawai/mengedit_peminjaman/?=id'.$this->input->get('id'),'class="form-horizontal"'); ?>
              <div class="box-body">
              ...
              <div class="box-footer">
                <a href="<?php  echo base_url()."index.php/c_pegawai/tampil_peminjaman"?>" class="btn btn-warning">Batal</a>
