...
<div class="box box-warning">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open('c_pegawai/tambah_detail_pinjam?id='.$this->input->get('id'),'class="form-horizontal"'); ?>
              <div class="box-body">
              ...
              <div class="box-footer">
                <a href="<?php echo site_url().'/c_pegawai/detail_peminjaman/?id='.$this->input->get('id');?>" class="btn btn-warning">Batal</a>
