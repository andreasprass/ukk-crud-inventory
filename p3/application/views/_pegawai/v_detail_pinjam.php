...
<div class="wrapper" style="height: auto; min-height: 100%;">
  ...
  <div class="content-wrapper" style="min-height: 921px;">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <a href="<?php echo site_url().'/c_pegawai/tampil_tambah_detail_pinjam/?id='.$this->input->get('id');?>" class="btn btn-primary" style="margin:10px;">
        ...
        <div class="box" >
          <div class="box-header">
            ...
            <a href="<?php  echo base_url()."index.php/c_pegawai/tampil_peminjaman"?>" class="btn btn-warning" style="margin:10px;"> Kembali
          </a>
        </div>
      </div>
    </div>
