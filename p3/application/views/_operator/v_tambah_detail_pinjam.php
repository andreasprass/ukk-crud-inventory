...
<div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Tambah Data Detail Pinjam</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open('c_operator/tambah_detail_pinjam?id='.$this->input->get('id'),'class="form-horizontal"'); ?>
              <div class="box-body">
              ...
              <div class="box-footer">
                <a href="<?php echo site_url().'/c_operator/detail_peminjaman/?id='.$this->input->get('id');?>" class="btn btn-warning">Batal</a>
