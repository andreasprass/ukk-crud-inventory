...
<div class="box box-warning">
            ...
            <!-- form start -->
            <?php echo form_open('c_operator/mengedit_peminjaman/?=id'.$this->input->get('id'),'class="form-horizontal"'); ?>
              <div class="box-body">
                <div class="form-group">
                  <label for="jenis" class="col-xs-3 control-label">Nama Pegawai</label>
                  <div class="col-sm-6">
              ...
              <div class="box-footer">
                <a href="<?php  echo base_url()."index.php/c_operator/tampil_peminjaman"?>" class="btn btn-warning">Batal</a>
