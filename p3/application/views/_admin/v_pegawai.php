...
<div class="wrapper" style="height: auto; min-height: 100%;">
  ...
  <div class="content-wrapper" style="min-height: 921px;">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <a href="<?php  echo base_url()."index.php/c_admin/tampil_tambah_pegawai"?>" class="btn btn-success" style="margin:10px;">
                <span class="glyphicon glyphicon-plus"></span>  Tambah Data Pegawai
          </a>
        <div class="box" >
            ...
            <div class="box-body">
              ...
              ?>
                <tr>
                  ...
                  <td><?php echo $row->username_pgw;?></td>
                  <td>
                    <a href="javascript:;" 
                    ...
                    data-username_pgw="<?php echo $row->username_pgw;?>"
                    data-toggle="modal" 
                    data-target="#edit_pegawai">
...
<?php 
  $this->load->view('_modal/edit_pegawai');
  $this->load->view('_modal/hapus_pegawai');
