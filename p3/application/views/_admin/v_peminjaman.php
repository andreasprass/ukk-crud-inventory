...
<div class="wrapper" style="height: auto; min-height: 100%;">
  ...
  <div class="content-wrapper" style="min-height: 921px;">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <a href="<?php  echo base_url()."index.php/c_admin/tampil_tambah_peminjaman"?>" class="btn btn-success" style="margin:10px;">
            ...
            <div class="box-body">
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <a href="<?php echo site_url().'/c_admin/detail_peminjaman/?id='.$row->id_peminjaman;?>">
...
<?php 
  $this->load->view('_modal/konfirmasi_pengembalian');
  $this->load->view('_modal/hapus_peminjaman');
