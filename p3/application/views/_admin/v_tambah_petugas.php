  ...
  <div class="content-wrapper" style="min-height: 921px;">
    ...
    <section class="content">
       <div class="callout callout-info">
            <p>Pastikan username yang anda daftarkan belum digunakan, jika 'username' sudah digunakan maka tambah petugas tidak akan diproses!</p>
          </div>
      <div class="row">
        <div class="col-xs-12">
      <!-- Horizontal Form -->
          <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open('c_admin/validasi_petugas','class="form-horizontal"'); ?>
              <div class="box-body">
                <div class="form-group">
                  <label for="namaPetugas" class="col-xs-3 control-label">Nama Petugas</label>
                  <div class="col-sm-6">
                  <input type="text" class="form-control" value="<?php echo set_value('nama_petugas'); ?>" name="nama_petugas" placeholder="Nama Petugas">
                ...
                <div class="form-group">
                  <label for="level" class="col-xs-3 control-label">Level</label>
                  <div class="col-sm-6">
