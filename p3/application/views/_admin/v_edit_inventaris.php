...
<div class="box box-warning">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open('c_admin/edit_inventaris?=id'.$this->input->get('id'),'class="form-horizontal"'); ?>
              <div class="box-body">
                <div class="form-group">
                  <label for="namaPetugas" class="col-xs-3 control-label">Nama Barang</label>
                  <div class="col-sm-6">
                  <input type="text" class="form-control" value="<?php foreach($data as $row){ echo $row->nama_barang;}?>" name="nama_barang" placeholder="Nama Barang">
                  </div>
                </div>
                <div class="form-group">
                  <label for="jenis" class="col-xs-3 control-label">Jenis</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" value="<?php foreach($data as $row){ echo $row->nama_jenis;}?>"  disabled>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                  <input type="text" class="form-control" value="<?php foreach($data as $row){ echo $row->kondisi;}?>" name="kondisi" placeholder="Kondisi">
                  </div>
                </div>
                <div class="form-group">
                  <label for="password" class="col-xs-3 control-label">Keterangan</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" value="<?php foreach($data as $row){ echo $row->keterangan_barang;}?>" name="keterangan" placeholder="Keterangan">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <div class="input-group date">
                      ...
                      <input type="text" class="form-control pull-right" value="<?php foreach($data as $row){ echo $row->tanggal_register;}?>" id="tanggal" name="tanggal">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" value="<?php foreach($data as $row){ echo $row->nama_ruang;}?>"  disabled>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                  <input type="text" class="form-control" value="<?php foreach($data as $row){ echo $row->kode_inventaris;}?>" name="kode_inventaris" placeholder="Kode Inventaris">
                  </div>
                </div>
                <div class="form-group">
                  <label for="username" class="col-xs-3 control-label">Jumlah Barang</label>
                  <div class="col-sm-6">
                  <input type="text" class="form-control" value="<?php foreach($data as $row){ echo $row->jumlah_barang;}?>" name="jumlah_barang" placeholder="Jumlah Barang">
                  </div>
                </div>
                <div class="form-group">
                  <label for="namaPetugas" class="col-xs-3 control-label">Nama Petugas</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" value="<?php foreach($data as $row){ echo $row->nama_petugas;}?>"  disabled>
