  ...
  <div class="content-wrapper" style="min-height: 921px;">
    ...
    <section class="content">
      <div class="callout callout-info">
        List Laporan Rekapitulasi Dari Peminjaman, Baik Yang Sedang Berlangsung Maupun Yang Sudah Dikembalikan!.
      </div>
      <div class="row">
        <div class="col-xs-12">
          <a href="<?php  echo base_url()."index.php/c_admin/cetak_laporan"?>" class="btn btn-success" style="margin:10px;">
