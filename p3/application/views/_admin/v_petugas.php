...
<div class="wrapper" style="height: auto; min-height: 100%;">
  ...
  <div class="content-wrapper" style="min-height: 921px;">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <a href="<?php  echo base_url()."index.php/c_admin/tampil_tambah_petugas"?>" class="btn btn-success" style="margin:10px;">
...
<?php 
  $this->load->view('_modal/edit_petugas');
  $this->load->view('_modal/hapus_petugas');
