...
<div class="wrapper" style="height: auto; min-height: 100%;">
  ...
  <div class="content-wrapper" style="min-height: 921px;">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <a href="<?php  echo base_url()."index.php/c_admin/tampil_tambah_inventaris"?>" class="btn btn-success" style="margin:10px;">
                <span class="glyphicon glyphicon-plus"></span>  Tambah Data Inventaris
          </a>
        <div class="box" >
            ...
            <div class="box-body">
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <a href="javascript:;"
                    data-id="<?php echo $row->id_inventaris;?>"
                    data-nama="<?php echo $row->nama_barang;?>"
                    data-kondisi="<?php echo $row->kondisi;?>"
                    data-keterangan_barang="<?php echo $row->keterangan_barang;?>"
                    data-tanggal_register="<?php echo $row->tanggal_register;?>"
                    data-kode_inventaris="<?php echo $row->kode_inventaris;?>"
                    data-jumlah_barang="<?php echo $row->jumlah_barang;?>"
                    data-toggle="modal"
                    data-target="#edit_data_inventaris">
...
<?php 
$this->load->view('_modal/edit_inventaris');
$this->load->view('_modal/hapus_inventaris');
